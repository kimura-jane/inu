// app.js
// TAF DOG MUSEUM 3D ギャラリー（エラー表示付きデバッグ版）
...
(() => {
  try {
    ...
    if (!canvas) {
      throw new Error('#scene キャンバスが見つかりません');
    }
    ...
    // ====== 視線ドラッグ ======
    let avatarGroup = null; // setAvatar 内で再代入されるので宣言位置を上に持ってきた
    ...
    div.textContent = 'JavaScript エラー: ' + err.message;
